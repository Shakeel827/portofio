          ...
          {category.skills.map((skill: Skill, skillIndex: number) => { 
            ...
            return ( 
              <div key={skillIndex} className="group/skill"> 
                ...
                {/* ✅ Fixed Progress Bar with Moving ⚡ */} 
                <div className={`h-3 rounded-full relative overflow-hidden bg-gradient-to-r ${colors.progressBg} border ${colors.border}`}> 
                  ...
                  > 
                    ...
                    {/* ⚡ Badge INSIDE bar fill */} 
                    <div className={`absolute -right-2 top-1/2 transform -translate-y-1/2 w-6 h-6 rounded-full ${colors.bg} border ${colors.border} flex items-center justify-center`}> 
